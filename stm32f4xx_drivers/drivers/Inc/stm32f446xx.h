...
/*
 * Base addresses of APB and AHB peripherals
 */
...
/*
 * GPIO base addresses Peripherals hanging on AHB1 Bus
 */
...
/*
 * Base addresses hanging in the APB1 Bus
 */
//I2C
...
/*
 * GPIO_X Register Definition using struct instead of tedious macro definition
 *
 */
typedef struct
{
	__vo uint32_t MODER;				/* From the register map, this the first register in the GPIO_X peripheral*/
	__vo uint32_t OTYPER;				/* Each uint32_t is an offset of 4 bytes as each register take 32 bits or 4 bytes*/
...
typedef struct
{
  __vo uint32_t CR1;        /*From the Register Map, First register withAddress offset: 0x00 */
...
#define I2C_CR2_ITERREN				 	8   //Error Enable
#define I2C_CR2_ITEVTEN				 	9  // Event Enable
#define I2C_CR2_ITBUFEN 			    10 // Buffer Enable
